...
<body>
    <h1 class="text-center">Picture Page</h1>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                    <a class="nav-link" href="ItemPage">Item Page <span class="sr-only">(current)</span></a>
            </ul>
        </div>
        <div>
            <a class="navbar-brand" href="{{ url('#') }}">Picture Page</a>
        </div>
    </nav>
